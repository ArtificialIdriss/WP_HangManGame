...
if (!isset($_SESSION['word'])) {
    ...
    $_SESSION['guessedLetters'] = [];  // Initialize guessed letters array
    $_SESSION['misses'] = 0;
    $_SESSION['score'] = 0;
}

// Ensure guessedLetters is initialized as an array before using it
...
<body>
    <div class="game-container">
        <img class="logo" src="hangmanlogo.png" alt="Hangman Logo">
